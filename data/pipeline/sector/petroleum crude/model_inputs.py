...
Fixed structural parameters
    raw_data/fixed_data/Petroleum Crude/petroleum_crude_{region}.csv
...
FIXED_INPUT_DIR = BASE_PATH / 'raw_data/fixed_data/Petroleum Crude'
OUTPUT_DIR      = BASE_PATH / 'model_inputs/model/petroleum crude'
