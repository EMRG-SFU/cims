...
Fixed structural parameters
    raw_data/fixed_data/Coal Mining/coal_mining_{region}.csv
...
FIXED_INPUT_DIR = BASE_PATH / 'raw_data/fixed_data/Coal Mining'
OUTPUT_DIR      = BASE_PATH / 'model_inputs/model/coal mining'
