...
Fixed structural parameters
    raw_data/fixed_data/Industrial Minerals/*.csv
...
FIXED_INPUT_DIR = BASE_PATH / 'raw_data/fixed_data/Industrial Minerals'
OUTPUT_DIR      = BASE_PATH / 'model_inputs/model/industrial minerals'
