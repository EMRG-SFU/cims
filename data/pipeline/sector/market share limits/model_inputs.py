...
Fixed structural parameters
    raw_data/fixed_data/market share limits/*.csv
...
# ── configuration ─────────────────────────────────────────────────────────────
FIXED_INPUT_DIR = BASE_PATH / 'raw_data/fixed_data/market share limits'
OUTPUT_DIR      = BASE_PATH / 'model_inputs/model/market share limits'
...
def main() -> pl.DataFrame:
    ...
    for region in regions:
        ...
        out_path = OUTPUT_DIR / f'market share limits_{region}.csv'
