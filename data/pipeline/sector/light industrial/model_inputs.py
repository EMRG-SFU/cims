...
Fixed structural parameters
    raw_data/fixed_data/Light Industrial/light_industrial_{region}.csv
...
FIXED_INPUT_DIR = BASE_PATH / 'raw_data/fixed_data/Light Industrial'
OUTPUT_DIR      = BASE_PATH / 'model_inputs/model/light industrial'
...
def _build_is_supply_rows(regions: list[str]) -> pl.DataFrame:
    ...
    return pl.DataFrame([
        {
            'Branch':      f'CIMS.CAN.{r}.Light Industrial',
            'Type':        'Sector',
            'Region':      r,
