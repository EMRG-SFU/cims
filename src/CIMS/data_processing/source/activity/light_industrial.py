...
from CIMS.data_processing.utils.extractors.stats_can import read_statscan_csv
from CIMS.data_processing.utils.controls_conversions import load_control_config, BASE_PATH
...
def main() -> pl.DataFrame:
    """Build light industrial DataFrame and write to CSV."""
